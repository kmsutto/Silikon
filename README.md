<img width="750" height="1500" alt="tv_banner" src="https://github.com/user-attachments/assets/791e9389-73dc-4272-9aef-e13bb4d9b7b2" />
...
2.  **Open project:**
    ...
    * Select `File > Open` and indicate with the jump project.

3.  **Synchronization and launch:**
    * Wait for indexing and Gradle synchronization to finish (`Gradle Sync`).
    * Select your device (emulator or real device).
